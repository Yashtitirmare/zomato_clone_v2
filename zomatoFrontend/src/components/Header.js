  ...
  return (
    <div>
      ...
      <Modal isOpen={isLoginModalOpen} style={customStyles}>
        ...
        <br />
        {/* <FacebookLogin
          appId={`${process.env.REACT_FACEBOOK_API}`} 
          autoLoad={false}
        ...
        <GoogleLogin
          clientId={`${process.env.REACT_GOOGLE_API}`}
          buttonText="Google"
        ...
        <FacebookLogin
          ...
          cssClass="fb__class"
          icon="fa-facebook"
          callback={responseFacebook} // FIXED: remove extra arrow function
          textButton=""
        />
